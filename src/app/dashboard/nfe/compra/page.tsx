...
export default function Page() {
  ...
  return (
    <BasePageLayout
      ...
      breadcrumbsPath={[{ label: 'Notas', to: `${NFE_DE_COMPRA.LIST_PAGE}` }, { label: 'Listar' }]}
      tools={
        <CrudTools.Root>
          <CrudTools.CreateButton createRoute={NFE_DE_COMPRA.CREATE_PAGE} title='Nova nota fiscal' />
        </CrudTools.Root>
      }
    >
      <MyDataGrid
